...
const DEFAULT_OPTIONS = {
  title: 'Netflix 解锁检测',
  fullContent: '🎉 完整解锁 Netflix ➟ #REGION_FLAG# #REGION_NAME#',
  fullIcon: 'checkmark.circle.fill',
  fullIconColor: '36CE66',
  fullStyle: 'good',
  onlyOriginalContent: '🥲 解锁 Netflix 自制剧 ➟ #REGION_FLAG# #REGION_NAME#',
