console.log("APP监控运行")
let
apps=["983337376","1436650069","1314212521","1347998487","1443988620","1449412357","1164801111","1495946973","333710667","961390574","373311252","673907758","1423330822","945993620","393670998","1154746981","390017969","1312014438","989565871","440488550","1134218562","1373567447","1261944766","1049254261","1067198688","1371929193","1489780246","697927927","718043190","360593530","284666222","1490527415","1455832781","469338840","1355476695"]
    ...
    results.forEach((x=>{
      ...
      if(JSON.stringify(app_monitor[x.trackId])!=JSON.stringify(infos[x.trackId])){
        if(x.version!=app_monitor[x.trackId].version){
          notifys.push(`🏷️${x.trackName} - 版本升级：${x.version}`)
        }
        if(x.formattedPrice!=app_monitor[x.trackId].formattedPrice){
                  notifys.push(`〽️${x.trackName} - 价格变化：${x.formattedPrice}`)
                }
      }}
      else{
