console.log("APP监控运行")
let
apps=["1005945537","1449412357","1164801111","1495946973","333710667","961390574","373311252","673907758","1423330822","945993620","393670998","1154746981","390017969","1312014438","989565871","440488550","1134218562","1373567447","1261944766","1049254261","1067198688","1371929193","1489780246","697927927","718043190","360593530","284666222","1490527415","1455832781","469338840","1355476695"]
let reg="us"
let config={
  ...
  if(results.length>0){
    ...
    results.forEach((x=>{
      ...
      if(JSON.stringify(app_monitor[x.trackId])!=JSON.stringify(infos[x.trackId])){
        ...
        notifys.push(`🏷️${x.trackName} - 版本：${x.version} 价格：${x.formattedPrice}`)
      }
    }))
